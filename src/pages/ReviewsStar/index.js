...
export default function ReviewsStar() {
  ...
  const [photoUrl, setPhoto] = useState('https://api.adorable.io/avatars/285/abott@adorable.png');
  ...
  const admincomment = routes.params.idParams;

  console.log("ADMIN", admincomment)
  ...
  async function handleSubmitComment() {
    ...
    await api
      .post(
        'comment',
        {name, photoUrl, comment, rating, admincomment},
